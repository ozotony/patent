<%@ page language="C#" autoeventwireup="true" CodeFile="xxindex_ren.cs" inherits="xxindex_ren" %>
...
mso-fareast-font-family:&quot;Times New Roman&quot;;mso-fareast-language:EN-GB">
        ...
        <tr>
            <td  align="center">
                &nbsp;<input type="button" name="Proceed" id="Proceed" value="Proceed" class="button" onclick="doProceed();return false;" /></td>
        </tr>
