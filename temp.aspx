<%@ page language="C#" autoeventwireup="true" CodeFile="temp.cs" inherits="temp" %>
...
<script language="javascript" type="text/javascript">
    function doPost(transID, amt, agent, xgt, cname, agentemail, agentpnumber, product_title,pc) {
        postwith('./xindex.aspx', { transID: transID, amt: amt, agent: agent, xgt: xgt, cname: cname, agentemail: agentemail, agentpnumber: agentpnumber, product_title: product_title, pc: pc});
    }   
	</script>
</head>
<body>
