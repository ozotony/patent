<%@ page language="C#" autoeventwireup="true" CodeFile="pt_refill.cs" inherits="pt_refill" maintainscrollpositiononpostback="true" %>
          ...
          <asp:TemplateField HeaderText="Information" HeaderStyle-HorizontalAlign="Left">
           ...
           <SelectedRowStyle BackColor="#C5BBAF" Font-Bold="True" ForeColor="#333333" />
            ...
            <tr>
                ...
                <td style="width:35%;"> <asp:DropDownList ID="select_country_pri" runat="server" CssClass="textbox" DataSourceID="ds_Nationality" DataTextField="name"   DataValueField="ID"  >
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:cldConnectionString %>" 
                    SelectCommand="SELECT * FROM [country]"></asp:SqlDataSource></td>
                <td style="width:35%;"><asp:TextBox ID="txt_application_no_pri" runat="server" class="textbox" Width="200px" ></asp:TextBox></td>
                <td style="width:10%;"> <asp:TextBox ID="txt_date_pri" runat="server" Width="70px" CssClass="txt_date_pri" ></asp:TextBox></td>
                </tr>
                </table></td>
            </tr>
