<%@ page language="C#" autoeventwireup="true" CodeFile="violation.cs" inherits="violation" %>
...
// <![CDATA[
        ...
        function Proceed_onclick() {
            window.location.href = "http://www.iponigeria.com";
        }
...
<div>
    ...
    <table align="center" width="100%" class="form">
        ...
        <tr>
            <td  align="center">
                &nbsp;<input type="button" name="Proceed" id="Proceed" value="Close" class="button" onclick="return Proceed_onclick()" />
                <asp:Button ID="Agreed" runat="server" Text="AGREED" class="button" 
                    onclick="Agreed_Click" />
                </td>
        </tr>
