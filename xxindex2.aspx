<%@ page language="C#" autoeventwireup="true" CodeFile="xxindex2.cs" inherits="xxindex2" %>
...
// <![CDATA[
        function Proceed_onclick() {
            window.location.href = "./xapplication.aspx";
        }
...
mso-fareast-font-family:&quot;Times New Roman&quot;;mso-fareast-language:EN-GB">
        ...
        <tr>
            <td  align="center">
                &nbsp;<input type="button" name="Proceed" id="Proceed" value="Proceed" class="button" onclick="return Proceed_onclick()" /></td>
        </tr>
