...
public partial class application_old : Page
{
    ...
    protected void SaveAll_Click(object sender, EventArgs e)
    {
        ...
        {
            string xid = Session["hwalletID"].ToString();
            status = t.updateHwallet(xid, "Used", xreg_date, txt_title_of_invention.Text).ToString();
        }
        if ((str != "") && (str != null))
        {
