...
public partial class tm_acknowledgement_Recordal : System.Web.UI.Page
{
    public string aid = "";
    public string amt = "";
    public string gt = "";
  ...
  public   List<pt.Recordal> recordal;
    public Applicant_Recordal applicant_recordal = new Applicant_Recordal();
