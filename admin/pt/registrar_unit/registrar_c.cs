...
public partial class  admin_pt_registrar_unit_registrar_c : Page
{
    public string admin = "";
    public int back;
    ...
    {
        //lt_mi = z.getPtInfoRSX("6", "Grant Patent", dis.ToString(), limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    lt_mi = z.getAdminSearchPtInfoRS("6", "Grant Patent", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        limit = 50L;
        //nume = z.getPtInfoRSCnt("6", "Grant Patent");
        //long num = nume / limit;
