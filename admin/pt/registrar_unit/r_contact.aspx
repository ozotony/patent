<%@ page language="C#" autoeventwireup="true"  CodeFile="r_contact.cs" inherits="admin_pt_registrar_unit_r_contact" %>
...
<body ng-controller="myController16">
    <form id="form1" runat="server">
    <div>
    <div class="container">
        <div class="sidebar">
            <a href="./pt_profile.aspx">PROFILE</a> <a href="../../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./red.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
          ...
          <tr>
            <td colspan="8"  class="tbbg"> WELCOME TO THE REGISTRARS OFFICE</td>
          </tr>
          <tr class="stripedout">
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="r_contact_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="r_contact_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="r_contact_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
