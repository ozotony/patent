<%@ page language="C#" autoeventwireup="true"  CodeFile="registrar_c.cs" inherits="admin_pt_registrar_unit_registrar_c" %>
...
<script language="javascript" type="text/javascript">
    function doPostResults(eu) {
        postwith('./registrar_c.aspx', { eu: eu });
    }
...
<body ng-controller="myController17">
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="registrar_c_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="registrar_c_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="registrar_c_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
