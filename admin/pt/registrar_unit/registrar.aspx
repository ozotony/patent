<%@ page language="C#" autoeventwireup="true"  CodeFile="registrar.cs" inherits="admin_pt_registrar_unit_registrar" maintainscrollpositiononpostback="true" %>
...
<body ng-controller="myController15">
   ...
   <div>
    <div class="container">
        ...
        <div class="content">
          ...
          <tr>
            <td colspan="8"  class="tbbg"> WELCOME TO THE REGISTRAR&#39;S UNIT</td>
          </tr>
          <tr class="stripedout">
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="registrar_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="registrar_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="registrar_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
