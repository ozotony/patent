...
public partial class  admin_pt_registrar_unit_registrar : Page
{
    public string admin = "";
    public int back;
    ...
    {
        //lt_mi = z.getPtInfoRSX("5", "Patentable", dis.ToString(), limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    lt_mi = z.getAdminSearchPtInfoRS("5", "Patentable", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //limit = 50L;
        //nume = z.getPtInfoRSCnt("5", "Patentable");
        //long num = nume / limit;
