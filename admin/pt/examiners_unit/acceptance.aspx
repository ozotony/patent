<%@ page language="C#" autoeventwireup="true"  CodeFile="acceptance.cs"  inherits="admin_pt_examiners_unit_acceptance " %>
...
<script language="javascript" type="text/javascript">
    function doPostResults(eu) {
        postwith('./acceptance.aspx', { eu: eu });
    }
...
<body ng-controller="myController12">
