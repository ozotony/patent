...
public partial class  admin_pt_examiners_unit_a_contact : Page
{
    public string admin = "";
    public int back;
    ...
    {
        //this.lt_mi = this.z.getPtInfoRSX("4", "A_Contact", this.dis.ToString(), this.limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    this.lt_mi = this.z.getAdminSearchPtInfoRS("4", "A_Contact", this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo);
        ...
        //    if (this.lt_mi.Count<zues.PtInfo>() > 0)
        //    {
        //        this.lt_mi = this.z.getAdminSearchPtInfoRS("1", "A_Contact", this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo);
        //    }
        //    else
        //    {
        //        this.criteria = "No result found for search criteria (" + this.kword.Value + ")!!";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //this.limit = 50L;
        //this.nume = this.z.getPtInfoRSCnt("4", "A_Contact");
