...
public partial class  admin_pt_examiners_unit_rej_renewal_details : Page
{
    public string admin = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.rbValid.SelectedValue == "Approved")
        {
            this.admin_status = "3";
        ...
        {
            base.Response.Redirect("./rej_renewal.aspx");
        }
    }
    ...
    {
        this.succ = this.z.a_x_pt_office(this.c_x.log_staff, this.admin_status, this.rbValid.SelectedValue, this.comment.Text, "", "", "", this.admin);
        if (this.succ != "0")
        {
