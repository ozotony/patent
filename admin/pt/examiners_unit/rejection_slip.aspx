<%@ page language="C#" autoeventwireup="true"  CodeFile="rejection_slip.cs"  inherits="admin_pt_examiners_unit_rejection_slip " %>
...
<script language="javascript" type="text/javascript">
    function doPostResults(eu) {
        postwith('./rejection_slip.aspx', { eu: eu });
    }
...
&nbsp;&nbsp;
       ...
       <%--   <tr class="stripedout">
        ...
        <tr>
            ...
            <td align="center">
               <a href="rejection_slip_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
