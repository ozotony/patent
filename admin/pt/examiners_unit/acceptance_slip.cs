...
public partial class  admin_pt_examiners_unit_acceptance_slip : Page
{
    public string admin = "";
    public int back;
    ...
    {
        //this.lt_mi = this.z.getAcceptedRSX("5", this.dis.ToString(), this.limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    this.lt_mi = this.z.getAdminSearchAcceptedRS("5", this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //this.limit = 50L;
        //this.nume = this.z.getAcceptedRSCnt("5");
