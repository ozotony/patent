<%@ page language="C#" autoeventwireup="true"  CodeFile="examination_r_details.cs"  inherits="admin_pt_examination_r_details " maintainscrollpositiononpostback="true" %>
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            <a href="./eprofile.aspx">PROFILE</a> 
