<%@ page language="C#" autoeventwireup="true"  CodeFile="e_contact.cs"  inherits="admin_pt_examiners_unit_e_contact " %>
...
<script src="../../../js/funk.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="../../../js/ng-modal.min.js"></script>
...
<body ng-controller="myController8">
              <modal-dialog show='dialogShown'  dialog-title='COMMENT'>
                     ...
                     <table width="100%" border="0" cellspacing="1" cellpadding="4" class="table" align="center">
                                        ...
                                        <tbody ng-repeat="row in displayedCollection2">
                                            <tr >
    ...
    <div class="container">
        <div class="sidebar">
            <a href="./profile.aspx">PROFILE</a> <a href="../../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a>
    ...
    <div class="shadow right">&nbsp;</div>
          ...
          <tr>
            <td colspan="8"  class="tbbg"> WELCOME TO THE PATENT EXAMINER 1 OFFICE</td>
          </tr>
          <tr class="stripedout">
...
&nbsp;&nbsp;
      ...
      <%--    <tr class="stripedout">
        ...
        <tr>
            ...
            <td align="center">
               <a href="e_contact_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <thead>
            <tr>
                ...
                <th st-sort="reg_no" class="tdcolheader">Open New Tab</th>
                 ...
                 <th st-sort="reg_no" class="tdcolheader">View Comments</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection" ng-class="{'pending-delete': add2(row)}">
                ...
                <td align="center"><a href="examination_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="examination_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
               

                <td align="center"> <input id="Button1" type="button"  ng-click="EditRow(row)" value="View Comments" />  </td>
