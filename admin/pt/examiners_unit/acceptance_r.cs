...
public partial class  admin_pt_examiners_unit_acceptance_r : Page
{
    public string admin = "";
    public int back;
    ...
    {
        //this.lt_mi = this.z.getPtInfoRSX("5", "Review Patent", this.dis.ToString(), this.limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    this.lt_mi = this.z.getAdminSearchPtInfoRS("5", "Review Patent", this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //this.limit = 50L;
        //this.nume = this.z.getPtInfoRSCnt("5", "Review Patent");
