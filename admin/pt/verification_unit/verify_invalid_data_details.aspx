<%@ page language="C#" autoeventwireup="true"  CodeFile="verify_invalid_data_details.cs" inherits="admin_pt_verification_unit_verify_invalid_data_details" maintainscrollpositiononpostback="true" %>
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="V_Contact">Contact Applicant</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
