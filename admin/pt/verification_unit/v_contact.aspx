<%@ page language="C#" autoeventwireup="true"  CodeFile="v_contact.cs" inherits="admin_pt_verification_unit_v_contact" %>
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="v_contact_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="v_contact_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="v_contact_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
