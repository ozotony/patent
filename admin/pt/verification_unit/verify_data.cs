...
public partial class admin_pt_verification_unit_verify_data : Page
{
    public string admin = "";
    public int back;
    ...
    {
       // lt_mi = z.getPtInfoRSX("1", "Fresh", dis.ToString(), limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    lt_mi = z.getAdminSearchPtInfoRS("1", "Fresh", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
