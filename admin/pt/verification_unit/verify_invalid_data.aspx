<%@ page language="C#" autoeventwireup="true"  CodeFile="verify_invalid_data.cs" inherits="admin_pt_verification_unit_verify_invalid_data" %>
...
<body ng-controller="myController3">
    ...
    <div class="container">
        <div class="sidebar">
            <a href="./profile.aspx">PROFILE</a> <a href="../../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./verification_unit/ved.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
          ...
          <tr>
            <td colspan="8"  class="tbbg"> WELCOME TO THE PAYMENT VERIFICATION OFFICE</td>
          </tr>
          <tr class="stripedout">
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="verify_invalid_data_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="verify_invalid_data_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="verify_invalid_data_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
