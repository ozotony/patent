<%@ page language="C#" autoeventwireup="true"  CodeFile="inv_renewal.cs" inherits="admin_pt_verification_unit_inv_renewal" %>
...
<body ng-controller="myController2">
    ...
    <div class="container">
        <div class="sidebar">
            <a href="./profile.aspx">PROFILE</a> <a href="../../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./ved.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
          ...
          <tr>
            <td   class="tbbg"> WELCOME TO THE PAYMENT VERIFICATION OFFICE</td>
          </tr>
          <tr >
            <td  align="center">
