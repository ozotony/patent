<%@ page language="C#" autoeventwireup="true"  CodeFile="verify_data.cs" inherits="admin_pt_verification_unit_verify_data" %>
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="verify_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
