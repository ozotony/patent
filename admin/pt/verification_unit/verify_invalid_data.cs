...
public partial class admin_pt_verification_unit_verify_invalid_data : Page
{
    public string admin = "";
    public int back;
    ...
    {
        //lt_mi = z.getPtInfoRSX("1", "Invalid", dis.ToString(), limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    lt_mi = z.getAdminSearchPtInfoRS("1", "Invalid", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //limit = 50L;
        //nume = z.getPtInfoRSCnt("1", "Invalid");
        //long num = nume / limit;
