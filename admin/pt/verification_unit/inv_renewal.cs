...
public partial class admin_pt_verification_unit_inv_renewal : Page
{
    public string admin = "";
    public string criteria = "";
    public string criteria_type = "";
    public string data_status = "Invalid";
    ...
    protected void gvX_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "TmViewClick")
        {
            ...
            Response.Redirect("inv_renewal_details.aspx?x=" + str);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //max = Convert.ToInt32(ConfigurationManager.AppSettings["v_ren_unit_limit"]);
        //if (!IsPostBack)
        //{
        //    gvX.PageSize = 100;
        //    Session["lt_m"] = null;
