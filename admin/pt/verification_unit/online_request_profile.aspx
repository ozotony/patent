<%@ page language="C#" autoeventwireup="true"  CodeFile="online_request_profile.cs" inherits="admin_pt_verification_unit_online_request_profile" %>
...
<body>
    ...
    <table align="center" width="100%" >
        ...
        <tr>
            ...
            <td style="width: 30%;" align="center">
                <a href="./inv_renewal.aspx">INVALID APPLICATIONS</a>
                 &nbsp;<br /><%Response.Write("( " + lt_inv + " )");%></td>
        </tr>
