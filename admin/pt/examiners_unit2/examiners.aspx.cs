...
public partial class admin_pt_examiners_unit2_examiners : System.Web.UI.Page
{
    public string admin = "";
    public int back;
    ...
    {
        this.lt_mi = this.z.getPtInfoRSX("3", "Search Conducted", this.dis.ToString(), this.limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        //{
        //    this.lt_mi = this.z.getAdminSearchPtInfoRS("3", "Search Conducted", this.selectSearchCriteria.SelectedValue, fulltext, this.dateFrom, this.dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //this.limit = 50L;
        //this.nume = this.z.getPtInfoRSCnt("3", "Search Conducted");
