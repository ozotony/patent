<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examiners.aspx.cs" Inherits="admin_pt_examiners_unit2_examiners" %>
...
&nbsp;&nbsp;
    ...
    <%--      <tr class="stripedout">
        ...
        <tr>
            ...
            <td align="center">
               <a href="examination_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
