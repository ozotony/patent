<%@ page language="C#" autoeventwireup="true" CodeFile="s_contact_details.cs" inherits="admin_pt_search_unit_s_contact_details" maintainscrollpositiononpostback="true" %>
       ...
       <tr>
        ...
        <tr>
            ...
            <td >
               ...
               {
                  // Response.Write("ATTACHED");
                   Response.Write("<a href=../" + lt_mi[0].claim_doc + " target='_blank'>View</a>");        
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>
        ...
        <tr>
            ...
            <td >
               ...
               {
                  // Response.Write("ATTACHED");
                   Response.Write("<a href=../" + lt_mi[0].pct_doc + " target='_blank'>View</a>");              
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>
        ...
        <tr>
            ...
            <td >
               ...
               {
                 //  Response.Write("ATTACHED");
                   Response.Write("<a href=../" + lt_mi[0].spec_doc + " target='_blank'>View</a>");        
         }  else { Response.Write("NONE"); 
               } %></td>
        </tr>
        <%}%>
        ...
        <tr>
            <td class="tbbg" colspan="2" align="center">  --- MESSAGE --- </td>
        </tr>
        <tr>
          ...
          <tr>
            <td align="right">
                DEADLINE FOR RESPONSE:</td>
            <td >
                  <asp:TextBox ID="txt_response_date" runat="server" Width="70px" 
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:Button ID="Confirm" runat="server" Text="Confirm" class="button" 
        ...
        <tr>
            <td align="center" colspan="2">
                ...
                <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                     <asp:ListItem Value="Search Conducted" >Search Conducted </asp:ListItem>
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:TextBox ID="new_comment" runat="server" Height="50px" TextMode="MultiLine" Width="98%"></asp:TextBox>
        ...
        <tr>
                  <td>
                      ...
                      <input id="Button1" type="button" ng-click="add4(model.content)" value="Update" />  </td>
