<%@ page language="C#" autoeventwireup="true" CodeFile="search.cs" inherits="admin_pt_search_unit_search" %>
...
&nbsp;&nbsp;
       ...
       <%--   <tr >
        ...
        <tr>
            ...
            <td align="center">
               <a href="search_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="search_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="search_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
