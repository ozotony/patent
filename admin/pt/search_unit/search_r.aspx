<%@ page language="C#" autoeventwireup="true" CodeFile="search_r.cs" inherits="admin_pt_search_unit_search_r" %>
...
<body  ng-controller="myController6">
 ...
 <a href="../../../cp.aspx?x=<% Response.Write(admin); %>">CHANGE PASSWORD</a> <a href="./sed.aspx">VIEW STATISTICS</a>
        </div>
        <div class="content">
            <div class="header">
                <div class="xmenu">
...
&nbsp;&nbsp;
       ...
       <%--   <tr class="stripedout">
        ...
        <tr>
            ...
            <td align="center">
               <a href="search_r_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>--%>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="search_r_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="search_r_details.aspx?x={{row.xID}}"><i class="fa fa-external-link"></i></a></td>
