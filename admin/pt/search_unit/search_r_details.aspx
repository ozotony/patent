<%@ page language="C#" autoeventwireup="true" CodeFile="search_r_details.cs" inherits="admin_pt_search_unit_search_r_details" maintainscrollpositiononpostback="true" %>
     ...
     <table align="center"  style="width:100%;" class="form" >
       ...
       <tr>
        ...
        <% if (swallet.ID == null)
                       { %>
        <tr>
            <td class="tbbg" colspan="2">--- PERFORM A SEARCH ---</td>
        </tr>
        <tr>
            <td align="center"  colspan="2"> 
                <asp:Button ID="btnPerformSearch" runat="server" class="button" 
                    Text="Perform Search" onclick="btnPerformSearch_Click" />
            </td>
        </tr>
        <% } else {%>
        <tr>
            <td class="tbbg" colspan="2">--- VIEW SEARCH RESULTS---</td>
        </tr>
        <tr>
            <td align="center"  colspan="2"> 
                <asp:Button ID="btnViewSearchReport" runat="server" class="button" 
                    Text="View Search" onclick="btnViewSearchReport_Click" /></td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                    <asp:ListItem Value="Search Conducted" >Search Conducted </asp:ListItem>
                      <asp:ListItem Value="S_Contact">Contact Applicant</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <% }%>
