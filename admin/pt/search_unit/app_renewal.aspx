<%@ Page Language="C#" AutoEventWireup="true" CodeFile="app_renewal.aspx.cs" Inherits="admin_pt_search_unit_app_renewal2" %>
    ...
    <%--      <tr class="stripedout">
        ...
        <thead>
            <tr>
                ...
                <th st-sort="reg_date" class="tdcolheader"> APPROVAL  DATE</th>

                <th st-sort="reg_no" class="tdcolheader">View </th>
                <th st-sort="reg_no" class="tdcolheader">Open New Tab</th>

                 <th st-sort="reg_no" class="tdcolheader">Print Certificate</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td align="center"><a href="app_renewal_details.aspx?x={{row.xID}}"><i class="fa fa-link"></i></a></td>
                <td align="center"><a target="_blank"  href="app_renewal_details.aspx?x={{row.xID}} "><i class="fa fa-external-link"></i></a></td>

                <td align="center"><a target="_blank"  href="app_renewal_details.aspx?x={{row.xID}} &x2=print"><i class="fa fa-external-link"></i></a></td>
