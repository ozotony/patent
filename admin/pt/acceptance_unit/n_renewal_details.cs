...
public partial class  admin_pt_acceptance_unit_n_renewal_details : Page
{
    public string admin = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["x"] != null)
        {
            ...
            Session["Agent_email"] = c_x.agt_email;
    ...
    protected void SendAlert()
    {
        ...
        if (Session["Cx"] != null)
        {
            ...
            if (email.sendMail("Commercial Law Department", renewal.agt_email, from, subject, msg, "") == "sent")
            {
                ...
                {
                    Response.Write("<script language=\"javascript\" type=\"text/javascript\" >alert('E-mail sent successfully to the agent')</script>");
                    Response.Redirect("./profile.aspx");
                }
                else
                {
                    Response.Write("<script language=\"javascript\" type=\"text/javascript\">alert('E-mail not sent, Please check your internet connection or try again later')</script>");
                }
            }
            else
            {
                Response.Write("<script language=\"javascript\" type=\"text/javascript\">alert('The E-mail could not be sent, Please check your internet connection or try again later')</script>");
            }
        }
    }
