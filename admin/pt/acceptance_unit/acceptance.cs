...
public partial class  admin_pt_acceptance_unit_acceptance : Page
{
    public string admin = "";
    public int back;
    ...
    {
        lt_mi = z.getPtInfoRSX("4", "Futher Review", dis.ToString(), limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            lt_mi = z.getAdminSearchPtInfoRS("4", "Futher Review", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        limit = 50L;
        nume = z.getPtInfoRSCnt("4", "Futher Review");
        long num = nume / limit;
