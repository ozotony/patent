...
public partial class  admin_pt_acceptance_unit_a_contact : Page
{
    public string admin = "";
    public int back;
    ...
    {
        lt_mi = z.getPtInfoRSX("4", "A_Contact", dis.ToString(), limit.ToString());
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        limit = 50L;
        nume = z.getPtInfoRSCnt("4", "A_Contact");
        long num = nume / limit;
