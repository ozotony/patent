...
public partial class  admin_pt_acceptance_unit_acceptance_r : Page
{
    public string admin = "";
    public int back;
    ...
    {
        lt_mi = z.getPtInfoRSX("5", "Review Patent", dis.ToString(), limit.ToString());
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            lt_mi = z.getAdminSearchPtInfoRS("5", "Review Patent", selectSearchCriteria.SelectedValue, fulltext, dateFrom, dateTo);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        limit = 50L;
        nume = z.getPtInfoRSCnt("5", "Review Patent");
        long num = nume / limit;
