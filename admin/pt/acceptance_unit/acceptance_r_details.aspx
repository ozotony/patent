<%@ page language="C#" autoeventwireup="true"  CodeFile="acceptance_r_details.cs"  inherits="admin_pt_acceptance_unit_acceptance_r_details" maintainscrollpositiononpostback="true" %>
            ...
            <td align="center"  colspan="2"> <asp:RadioButtonList ID="rbValid" runat="server" RepeatDirection="Horizontal" onselectedindexchanged="rbValid_SelectedIndexChanged" AutoPostBack="True">
                   <asp:ListItem Value="Patentable" >Patentable</asp:ListItem>
                    <asp:ListItem Value="Not-Patentable">Not Patentable</asp:ListItem>
                      <asp:ListItem Value="A_Contact">Contact Applicant</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
