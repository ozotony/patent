<%@ page language="C#" autoeventwireup="true"  CodeFile="a_contact.cs"  inherits="admin_pt_acceptance_unit_a_contact" %>
...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="center">
               <a href="a_contact_details.aspx?x=<%= lt_mi[i].xID.ToString() %>">View</a>
            </td>
        </tr>
        <% sn++; } 
             }%>
