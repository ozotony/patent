<%@ page language="C#" autoeventwireup="true"  CodeFile="app_renewal_details.cs"  inherits="admin_pt_acceptance_unit_app_renewal_details" maintainscrollpositiononpostback="true" %>
        ...
        <tr>
           ...
           %>      
            ...
            <td align="center">
                ...
                <asp:Button ID="Verify" runat="server" Text="Print Certificate" OnClick="Verify_Click" class="button" />
            </td>
        </tr>
            </table>
        </div>
