<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tm_acknowledgement2.aspx.cs" Inherits="admin_pt_x_unit_tm_acknowledgement2" %>
...
<body>
  ...
  <%--              <input type="button" name="IpoDashboard" id="Button3" value="Back to Dashboard" class="button" onclick="return IpoDashboard_onclick()" />--%>
