...
public partial class admin_pt_x_unit_edit_form2 : System.Web.UI.Page
{
    public string admin = "";
    ...
    protected void SaveAll_Click(object sender, EventArgs e)
    {
        ...
        c_ptinfo.reg_number = TextBox2.Text;
        lt_mix[0].reg_number = TextBox2.Text;
        ...
        else
        {
            ...
            {
                mix_updateID = t.updatePtInfo2(c_ptinfo);
