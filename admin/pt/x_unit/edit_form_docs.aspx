<%@ page language="C#" autoeventwireup="true" CodeFile="edit_form_docs.cs" inherits="admin_pt_x_unit_edit_form_docs" maintainscrollpositiononpostback="true" %>
           ...
           <td colspan="3">                       
            ...
            <tr>
				...
				EnableClientScript="True"  runat="server"/>
                    ...
                    <td align="left" >
                    <%if (loa_doc != "") { Response.Write("<a href='" + loa_doc + "' target='blank'>View</a>"); } else { Response.Write("No Document Attached"); } %> 
                          </td>                       
                </tr>               
